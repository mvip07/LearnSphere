    ...
    theme: {
        extend: {
            ...
            animation: {
                ...
                float: 'float 6s ease-in-out forwards',
                'morph-1': 'morph-1 4s infinite ease-in-out',
                'morph-2': 'morph-2 5s infinite ease-in-out',
                'morph-3': 'morph-3 6s infinite ease-in-out',
                'morph-4': 'morph-4 7s infinite ease-in-out',
                'morph-5': 'morph-5 8s infinite ease-in-out',
