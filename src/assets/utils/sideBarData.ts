...
export const CABINETSIDEBAR = [
    ...
    { id: 5, icon: FaQuestion, url: "/cabinet/quiz-games", titleKey: "questionTest", disabled: false },
    { id: 6, icon: FaRegEnvelope, url: "/cabinet/messages", titleKey: "messages", disabled: false },
    { id: 7, icon: FaRegUser, url: "/cabinet/rankings/users", titleKey: "ranking", disabled: false },
    { id: 2, icon: FaUserPen, url: "/cabinet/profile", titleKey: "profileEdit", disabled: false },
