                                        ...
                                        <div className="flex flex-wrap gap-2 mb-4">
                                            {quiz.tags.map((tag, i) => (
                                                <span
                                                    ...
                                                    className="inline-block px-3 py-1 text-xs font-semibold bg-gray-100 text-gray-800 rounded-full transition-all duration-300 hover:bg-blue-100 hover:text-blue-800 animate-tag"
                                                >
                                                    {tag}
                                                </span>
                                            ))}
