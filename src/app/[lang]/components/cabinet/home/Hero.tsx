    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-gradient-to-br from-indigo-900 to-purple-900">
            ...
            <div ref={textRef} className="absolute inset-0 flex flex-col items-center justify-center text-center text-white">
                ...
                <button ref={ctaRef} onClick={() => goTo("auth/login")} className="px-8 py-4 bg-indigo-600 text-white text-lg font-semibold rounded-full hover:bg-indigo-700 transition-colors duration-300 cursor-pointer">
                    Start Learning
                </button>
            </div>
