...
export const metadata: Metadata = {
    title: "Check Your Email - Complete the Process",
    description: "We've sent you an email with further instructions. Please check your inbox to proceed. Ensure your account is verified securely.",
};
